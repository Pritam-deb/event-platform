...
function formatRange(startAt: Event["startAt"], endAt: Event["endAt"]) {
...
export default function EventDetailPage() {
  ...
  const status =
    (data?.eventStatus as "DRAFT" | "ACTIVE" | "COMPLETED" | "CANCELLED") ??
        ...
        <aside className="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur">
          ...
          <div className="mt-4 space-y-3">
            ...
            <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/7 to-white/3 p-4 text-center">
              ...
              <div className="mt-3 text-xs text-white/50">Unique Attendees</div>
              <div className="mt-1 text-xl font-semibold">
      ...
      <section className="mt-4 grid gap-4 lg:grid-cols-[260px_1fr]">
        <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur">
          ...
          <div className="mt-3 space-y-3 text-sm">
            {["Gastonia Ghost Peppers", "Charleston Dirty Birds"].map(
              (name) => (
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            {[
              ...
              {
                label: "Music Lover",
                tone: "bg-violet-500/10 text-violet-200 border-violet-500/20",
              },
              {
                label: "Loyal",
              ...
              },
              {
                ...
                tone: "bg-stone-500/10 text-stone-200 border-stone-500/20",
              },
              {
